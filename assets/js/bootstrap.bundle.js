...
(function (global, factory) {
    ...
    */
    ...
    const SELECTOR_DATA_TOGGLE_BACK$1 = '[data-bs-toggle="offcanvas-back"]';
    const Default$5 = {
      backdrop: true,
      keyboard: true,
      scroll: false
    ...
    class Offcanvas extends BaseComponent {
      ...
      hideAll(){
        const allOpen = SelectorEngine.find(OPEN_SELECTOR);
        allOpen.forEach((ele) => {
          Offcanvas.getInstance(ele).hide();
        });
      };
    ...
    enableDismissTrigger(Offcanvas, 'hideAll');
