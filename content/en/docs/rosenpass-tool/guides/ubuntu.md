...
This page provides you with installation and usage guides to get started with Rosenpass on Ubuntu. Most users should start with the [Installation via the Binary Files](#installation-via-binary-files).
...
Rosenpass provides pre-built binary files for x86 64-bit Ubuntu. This is the most common architecture. If you need something else, you are advised to [compile Rosenpass from source](#compile-it-from-source).
...
<small>Version notice: This guide was last tested on March 10, 2025, under Ubuntu 24.10 Mantic Minotaur.</small>
