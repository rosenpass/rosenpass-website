...
- Renamed EKEM/SKEM to EphemeralKEM/StaticKEM
...
- Added QC CI code independent of Nix (dissimilar redundancy, yay!)
...
- Introduced Cachix for CI Nix caching (finally bearable feedback in time for more eager contributors)
